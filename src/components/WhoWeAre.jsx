...
const WhoWeAre = () => {
  return (
    <div className="bg-gray-100 pb-4 min-h-screen flex flex-col justify-center items-center">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">WHO WE ARE</h1>
      {/* Card Container */}
      <div className="bg-white shadow-lg rounded-lg w-full md:w-11/12 lg:w-10/12 p-8 flex flex-col md:flex-row"> 
