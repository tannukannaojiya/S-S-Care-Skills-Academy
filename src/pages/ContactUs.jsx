          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                S&S Care Skills Academy is a leading hands-on learning provider 
                in various technical courses such as AC Repair, PCB Repair, Mobile 
                ...
                hands-on labs to become employable/potential learners.
                </p>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                    info@careskillsacademy.in <br/>
                    contacts@careskillsacademy.in
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form action="https://formspree.io/f/mwpkqpzw" method="POST" name="contact" netlify>
                  <ContactInputBox
                    type="text"
                    name="name"
